form.addEventListener("Submit", function (event) {
  ...
  var docu1 = document.querySelector("#dish1");
  var docu2 = document.querySelector("#dish2");
  var docu3 = document.querySelector("#dish3");
  var docu4 = document.querySelector("#dish4");
  var docu5 = document.querySelector("#dish5 ");
  var docu6 = document.querySelector("#dish6");
  var count = 0;
  if (docu1.checked) {
    count++;
  }
  ...
  if (count >= 2) {
    ...
    window.alert("Must choose atleast two foods items");
  }
